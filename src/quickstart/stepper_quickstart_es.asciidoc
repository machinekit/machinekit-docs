...
y Debian antes de continuar. Para instalaciones mas complejas vea el 
...
en el sitio wiki del Machinekit que es administrado por los mismos usuarios, 
en la siguiente dirección: http://wiki.machinekit.org/[list]
