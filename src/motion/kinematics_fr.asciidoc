...
Cartésiennes. Une partie du contrôleur de mouvements de Machinekit est
...
X, Z et A et que le fichier d'init de Machinekit contient uniquement la
...
suppose que joint1=Y. Pour faire en sorte que cela fonctionne dans Machinekit
il suffit de définir tous les axes (XYZA), Machinekit utilisera alors une
