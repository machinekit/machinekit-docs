...
If your working with an installed version of Machinekit you need to install
the development packages by using the following line in a terminal or using the 
Synaptic Package Manager from the main Debian menu.
...
'emc2/src/hal/components' and will be built unless Machinekit is 
