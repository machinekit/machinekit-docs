...
machine de Machinekit.

Pour charger un panneau PyVCP autonome avec Machinekit utiliser cette
commande:
...
par un des contrôleurs machine de Machinekit, par exemple pour des tests ou
une visu autonome.
