...
image::http://preview.machinekit.io/docs/gui/images/sketch_auto_tool_measurement.png[align="left"]
...
image::http://preview.machinekit.io/docs/gui/images/strange_numbers.png[align="left"]
