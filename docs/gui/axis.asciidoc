...
Full details in the link:../axis-machinekit-enhancements[Axis Machinekit Enhancements]
...
* image:tool_estop.gif[] Toggle Emergency Stop [F1] (also called E-Stop)(((ESTOP))))

* image:tool_power.gif[] Toggle Machine Power [F2](((machine on)))

* image:tool_open.gif[] Open G Code file [O]

* image:tool_reload.gif[] Reload current file [Ctrl-R]

* image:tool_run.gif[] Begin executing the current file [R]

* image:tool_step.gif[] Execute next line [T]

* image:tool_pause.gif[] Pause Execution [P] Resume Execution[S]

* image:tool_stop.gif[] Stop Program Execution [ESC]

* image:tool_blockdelete.gif[] Toggle Skip lines with "/" [Alt-M-/]

* image:tool_optpause.gif[] Toggle Optional Pause [Alt-M-1]

* image:tool_zoomin.gif[] Zoom In

* image:tool_zoomout.gif[] Zoom Out

* image:tool_axis_z.gif[] Top view

* image:tool_axis_z2.gif[] Rotated Top view

* image:tool_axis_x.gif[] Side view

* image:tool_axis_y.gif[] Front view

* image:tool_axis_p.gif[] Perspective view

* image:tool_rotate.gif[] Toggle between Drag and Rotate Mode [D]

* image:tool_clear.gif[] Clear live backplot [Ctrl-K]
...
image::axis-outofrange.png[align="center"]
...
image::axis-currentandselected.png[align="center"]
...
image::touchoff.png[align="center"]
...
image::axis-mdi.png[align="center"]
...
image::axis-emc-status.png[align="center"]
...
image::manual-tool-change.png[align="center"]
...
image:axis-lathe-tool.png[align="center"]
...
Full details in the below 

== link:../axis-machinekit-enhancements[Machinekit Specific Axis Enhancements]
