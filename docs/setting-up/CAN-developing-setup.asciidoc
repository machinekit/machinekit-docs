...
image::http://preview.machinekit.io/docs/setting-up/images/wireshark-startup.png[align="center"]
...
image::http://preview.machinekit.io/docs/setting-up/images/captured-can-packet.png[align="center"]

You are now ready to return to the the link:http://preview.machinekit.io/docs/developing/CAN-developing[CAN developing page]
