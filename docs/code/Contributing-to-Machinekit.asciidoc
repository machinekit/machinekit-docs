...
The main Machinekit git repo is at:
...
* Fork the git repo into your account at github and clone it locally on your system

* Commit the changes you desire to a local branch

* Push your new branch to your fork and create a Pull Request to the main
  machinekit repo
...
* It is not uncommon for a PR to go through several revisions before
   it is accepted.
...
* Reporting bugs on the forum or github issues
