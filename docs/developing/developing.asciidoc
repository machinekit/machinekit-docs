...
. link:http://preview.machinekit.io/docs/getting-started/installing-packages#configure-apt[Configure Apt]
. link:http://preview.machinekit.io/docs/getting-started/installing-packages#install-RT-kernel[Install the kernel of your choice]
